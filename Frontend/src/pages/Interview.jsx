...
export default function Interview() {
  ...
  // ── Setup data from Home page (or Resume flow) ──────────────────────────
  const {
    role = 'React Developer',
    difficulty = 'Medium',
    interviewType = 'text',
    preloadedSession = null,   // set by ResumeInterviewButton for resume-based interviews
    isResumeBased = false,
  } = location.state || {}
  ...
  useEffect(() => {
    ...
    async function init() {
      try {
        ...
        let sessionData
        if (preloadedSession) {
          // Resume-based interview: questions already generated by /resume/questions
          sessionData = preloadedSession
        } else {
          // Role-based interview: generate questions via /interview/start
          sessionData = await startInterview({
            role,
            difficulty,
        ...
        const greeting = isResumeBased
          ? `Welcome! I'm your AI interviewer. I've analyzed your resume and prepared ${sessionData.questions.length} personalized questions based on your skills. I'll provide detailed feedback after each answer.\n\nLet's begin!`
          : `Welcome! I'm your AI interviewer for this ${difficulty} ${role} interview. I'll ask you ${TOTAL_QUESTIONS} questions and provide detailed feedback after each answer.\n\nLet's begin!`
